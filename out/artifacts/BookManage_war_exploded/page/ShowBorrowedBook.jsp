...
<%List<BorrowedBooks> books=(ArrayList)request.getAttribute("bookslist");%>
	<div style="margin: 0 auto; width: 1000px;">
	<div class="layui-btn-container" style="width: 1200px;">
  <%for(int i = 0; i < books.size(); i++){%>
  		<button class="layui-btn btl"  onclick="location.href='PreReadDetail.da?DetailBookName=<%=books.get(i).getBookName() %>&borrower=<%=books.get(i).getBorrower() %>'" type="button">
