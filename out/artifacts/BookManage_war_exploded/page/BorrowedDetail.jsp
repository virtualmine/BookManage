  ...
  %>
    ...
    <table width="500"  border="0">
      ...
      <tr height="120" style="text-align:center">
          <td colspan="5">
              <button class="layui-btn" onclick="location.href='borrowbook.da?borrower=<%=request.getAttribute("borrower")%>'"><i class="layui-icon">&#xe65c;</i>&nbsp;返回</button>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              
              
              <%if(Count<8){%>
              	<button class="layui-btn" onclick="location.href='borrowing.da?borrower=<%=request.getAttribute("borrower")%>&borrowedbookname=<%out.print(b.getBookName()); %>'"><i class="layui-icon">&#xe657;</i>&nbsp;借书</button>
              <%}else if(Count==8){%>
              	<button class="layui-btn layui-btn-disabled"><i class="layui-icon">&#xe657;</i>&nbsp;借书</button>
              <%} %>
